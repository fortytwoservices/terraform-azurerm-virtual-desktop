...
module "avd1" {
  ...
  env                = "dev"              # Dev, module expects single letter
...
|------|-------------|------|---------|:--------:|
| <a name="input_shortname"></a> [shortname](#input\_shortname) | A short version of the customer name. Eg. Fortytwo would be ft | `string` | `null` | no |
